...
y_teacher = np.empty(x_train.shape+(9,))
for i, x in enumerate(x_train):
    y_teacher[i,:] = id_teacher_predict[x]
y_train[:,[2,4,7,8]] = y_teacher[:,[2,4,7,8]]
...
# model.summary()
x = np.array([id_vector[x] for x in x_train])
